        ...
        <div>
            <StyleProject>
                <StyleContentsArea theme={theme}>
                    <StyleContentsLeft>
                        <blockquote>
                            <StyleProjectTitle>2021.08 - 2024.02</StyleProjectTitle>
                    ...
                    <StyleContentsRight>
                        ...
                        <StyleContents>
                            ...
                            <StyleContent>최초 0.1req/s 이내의 트래픽을 시작으로, 서비스 확장과 함께 900배 이상의 트래픽을 안정적으로 운영</StyleContent>
                        </StyleContents>
                        ...
                        <StyleContents>
                            ...
                            <StyleContent>상품 시스템과 연동하여 모델별 다양한 요건의 상품을 모아볼 수 있는 카탈로그 페이지 API개발</StyleContent>
                            <StyleContent>주문 시스템의 kinesis 이벤트 수신 처리에 따른 모델별 거래 내역 스냅샷 및 시세 API 개발 </StyleContent>
                        </StyleContents>
                        <StyleImages>
